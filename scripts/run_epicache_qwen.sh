...
SCORE_PATH=data/layer_scores/booksum_Qwen2.5-${SCALE}B-Instruct_sample0_layer_scores.json
...
CUDA_VISIBLE_DEVICES=$1 python -B run_epicache.py --model $MODEL --data $DATA --embedding_type $EMBEDDING_TYPE \
